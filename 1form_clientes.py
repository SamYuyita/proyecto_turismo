...
class FormularioClientes:
    ...
    def consulta_por_codigo(self):
        ...
        self.label6=ttk.Label(self.labelframe2, text="Telefono:")        
    ...
    def modificar(self):
        ...
        self.entrynombremod=ttk.Entry(self.labelframe5, textvariable=self.nombremod)
        ...
        self.entryapellidomod=ttk.Entry(self.labelframe5, textvariable=self.apellidomod)
        self.entryapellidomod.grid(column=1, row=2, padx=4, pady=4)
        
        self.label3=ttk.Label(self.labelframe5, text="DNI:")        
        self.label3.grid(column=0, row=3, padx=4, pady=4)
        self.dnimod=tk.StringVar()
        self.entrydnimod=ttk.Entry(self.labelframe5, textvariable=self.dnimod)
        self.entrydnimod.grid(column=1, row=3, padx=4, pady=4)
        
        self.label3=ttk.Label(self.labelframe5, text="Email:")        
        self.label3.grid(column=0, row=4, padx=4, pady=4)
        self.emailmod=tk.StringVar()
        self.entryemailmod=ttk.Entry(self.labelframe5, textvariable=self.emailmod)
        self.entryemailmod.grid(column=1, row=4, padx=4, pady=4)
        ...
        self.entrytelefonomod=ttk.Entry(self.labelframe5, textvariable=self.telefonomod)
        self.entrytelefonomod.grid(column=1, row=5, padx=4, pady=4)
    ...
    def modifica(self):
        datos=(self.nombremod.get(), self.apellidomod.get(), self.dnimod.get(), self.emailmod.get(), self.telefonomod.get(), self.codigomod.get())
        cantidad=self.cliente1.modificacion(datos)
        if cantidad==1:
    ...
    def consultar_mod(self):
        ...
        if len(respuesta)>0:
            ...
            self.emailmod.set(respuesta[0][3])
