...
class FormularioReservas:
    ...
    def consulta_por_codigo(self):
        ...
        self.label1=ttk.Label(self.labelframe2, text="Código circuito:")
        self.label1.grid(column=0, row=1, padx=4, pady=4)
        self.codigocircuito=tk.StringVar()
        self.entrycodigocircuito=ttk.Entry(self.labelframe2, textvariable=self.codigocircuito, state="readonly")
        self.entrycodigocircuito.grid(column=1, row=1, padx=4, pady=4)
        
        self.label1=ttk.Label(self.labelframe2, text="Código hotel:")
        self.label1.grid(column=0, row=2, padx=4, pady=4)
        self.codigohotel=tk.StringVar()
        self.entrycodigohotel=ttk.Entry(self.labelframe2, textvariable=self.codigohotel, state="readonly")
        self.entrycodigohotel.grid(column=1, row=2, padx=4, pady=4)
        
        self.label1=ttk.Label(self.labelframe2, text="Código vuelo:")
        self.label1.grid(column=0, row=3, padx=4, pady=4)
        self.codigovuelo=tk.StringVar()
        self.entrycodigovuelo=ttk.Entry(self.labelframe2, textvariable=self.codigovuelo, state="readonly")
        self.entrycodigovuelo.grid(column=1, row=3, padx=4, pady=4)
        ...
        self.entryasientocons.grid(column=1, row=4, padx=4, pady=4)
        
        self.label3=ttk.Label(self.labelframe2, text="Fecha:")        
        self.label3.grid(column=0, row=5, padx=4, pady=4)
        self.fechacons=tk.StringVar()
        self.entryfechacons=ttk.Entry(self.labelframe2, textvariable=self.fechacons, state="readonly")
        self.entryfechacons.grid(column=1, row=5, padx=4, pady=4)
        
        self.label1=ttk.Label(self.labelframe2, text="Código cliente:")
        self.label1.grid(column=0, row=6, padx=4, pady=4)
        self.codigocliente=tk.StringVar()
        self.entrycodigocliente=ttk.Entry(self.labelframe2, textvariable=self.codigocliente, state="readonly")
        self.entrycodigocliente.grid(column=1, row=6, padx=4, pady=4)
        
        self.label1=ttk.Label(self.labelframe2, text="Código agencia:")
        self.label1.grid(column=0, row=7, padx=4, pady=4)
        self.codigoagencia=tk.StringVar()
        self.entrycodigoagencia=ttk.Entry(self.labelframe2, textvariable=self.codigoagencia, state="readonly")
        self.entrycodigoagencia.grid(column=1, row=7, padx=4, pady=4)
    ...
    def consultar(self):
        ...
        if len(respuesta)>0:
            self.codigocircuito.set(respuesta[0][0])
            self.codigohotel.set(respuesta[0][1])
            self.codigovuelo.set(respuesta[0][2])
            self.asientocons.set(respuesta[0][3])
            self.fechacons.set(respuesta[0][4])
            self.codigocliente.set(respuesta[0][5])
            self.codigoagencia.set(respuesta[0][6])
        else:
            self.codigocircuito.set('')
            self.codigohotel.set('')
            self.codigovuelo.set('')
            self.asientocons.set('')
            self.fechacons.set('')
            self.codigocliente.set('')
            self.codigoagencia.set('')
