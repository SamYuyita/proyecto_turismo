...
class FormularioAeropuertos:
    ...
    def borrado(self):
        ...
        self.cuaderno1.add(self.pagina4, text="Borrar aeropuerto")
        
        self.labelframe4=ttk.LabelFrame(self.pagina4, text="Aeropuerto")        
    ...
    def borrar(self):
        ...
        cantidad=self.aeropuerto1.baja(datos)
        if cantidad==1:
            mb.showinfo("Información", "Se borró el aeropuerto con dicho código")
        else:
            mb.showinfo("Información", "No existe un aeropuerto con dicho código")
